...
export class Alquiler {
  ...
  @Column({ name: 'subtotal', type: 'numeric', precision: 12, scale: 2, default: 0 }) subtotal: number = 0;
  @Column({ name: 'total_penalidades', type: 'numeric', precision: 12, scale: 2, default: 0 }) totalPenalidades: number = 0;
  @Column({ name: 'total_pagado', type: 'numeric', precision: 12, scale: 2, default: 0 }) totalPagado: number = 0;
...
export class AlquilerItem {
  ...
  @Column({ type: 'numeric', precision: 12, scale: 2, default: 0 }) subtotal: number = 0;
  @CreateDateColumn({ name: 'created_at', type: 'timestamptz' }) createdAt!: Date;
