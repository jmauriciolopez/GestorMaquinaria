...
export class Tarifa {
  ...
  @Column({ name: 'precio_por_hora', type: 'numeric', precision: 10, scale: 2, nullable: true }) precioPorHora?: number;
  ...
  @Column({ name: 'deposito_garantia', type: 'numeric', precision: 10, scale: 2, default: 0 }) depositoGarantia: number;
